...
class CountDownItem(models.Model):
    ...
    image_origin=models.ImageField(_("تصویر"), upload_to=IMAGE_FOLDER+'CountDownItem/',null=True,blank=True, height_field=None, width_field=None, max_length=None)
...
class Page(models.Model):
    ...
    comments=models.ManyToManyField("Comment",related_name="page_for_comment", verbose_name=_("نطر ها"),blank=True)
