    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', tinymce.models.HTMLField(blank=True, max_length=100000, null=True, verbose_name='شرح کامل')),
                ...
                ('priority', models.IntegerField(default=100, verbose_name='ترتیب')),
                ('comments', models.ManyToManyField(blank=True, related_name='page_for_comment', to='dashboard.Comment', verbose_name='نطر ها')),
