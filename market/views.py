...
class ShopView(View):
    ...
    def brand(self,request,brand_id,*args, **kwargs):
        ...
        return render(request=request,template_name=TEMPLATE_ROOT+'shop.html',context=context)
...
class ProductView(View): 
    ...
    def product(self,request,product_id):
        ...
        return render(request=request,template_name=TEMPLATE_ROOT+'product.html',context=context)
    ...
    def search(self,request):        
        ...
        if request.method=='POST':
            ...
            if search_form.is_valid():
                ...
                return render(request,TEMPLATE_ROOT+'shop.html',context=context)            
            return render(request,TEMPLATE_ROOT+'search.html',context=context)                
        return render(request,TEMPLATE_ROOT+'search.html',context=context)
