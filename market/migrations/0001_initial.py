...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('icon', models.CharField(choices=[('engineering', 'engineering'), ('account_circle', 'account_circle'), ('add_shopping_cart', 'add_shopping_cart'), ('apartment', 'apartment'), ('alarm', 'alarm'), ('attach_file', 'attach_file'), ('attach_money', 'attach_money'), ('backup', 'backup'), ('build', 'build'), ('card_travel', 'card_travel'), ('chat', 'chat'), ('construction', 'construction'), ('dashboard', 'dashboard'), ('delete', 'delete'), ('description', 'description'), ('extension', 'extension'), ('face', 'face'), ('favorite', 'favorite'), ('fingerprint', 'fingerprint'), ('get_app', 'get_app'), ('help_outline', 'help_outline'), ('home', 'home'), ('important_devices', 'important_devices'), ('link', 'link'), ('local_shipping', 'local_shipping'), ('lock', 'lock'), ('mail', 'mail'), ('notification_important', 'notification_important'), ('place', 'place'), ('psychology', 'psychology'), ('publish', 'publish'), ('reply', 'reply'), ('schedule', 'schedule'), ('send', 'send'), ('settings', 'settings'), ('share', 'share'), ('sync', 'sync'), ('verified_user', 'verified_user'), ('vpn_key', 'vpn_key'), ('weekend', 'weekend')], default='important_devices', max_length=50, verbose_name='icon')),
                ('prefix', models.CharField(blank=True, default='', max_length=200, null=True, verbose_name='پیش تعریف')),
