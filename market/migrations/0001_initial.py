    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_description', tinymce.models.HTMLField(blank=True, max_length=500, null=True, verbose_name='شرح کوتاه')),
                ...
                ('colors', models.ManyToManyField(blank=True, to='market.Color', verbose_name='رنگ ها')),
