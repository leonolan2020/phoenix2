    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_header_origin', models.ImageField(blank=True, null=True, upload_to='market/images/Category/Header/', verbose_name='تصویر سربرگ')),
                ('rate', models.IntegerField(default=0, verbose_name='امتیاز')),
                ('priority', models.IntegerField(default=1000, verbose_name='ترتیب')),
        ...
        migrations.CreateModel(
            name='MetaData',
            fields=[
                ('metadata_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='market_MetaData', serialize=False, to='dashboard.metadata')),
            ],
            options={
                'verbose_name': 'MetaData',
                'verbose_name_plural': 'MetaDatas',
                'default_related_name': 'market_MetaData',
            },
        ...
        migrations.CreateModel(
            name='OurTeam',
            fields=[
                ('ourteam_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='market_OurTeam', serialize=False, to='dashboard.ourteam')),
            ],
            options={
                'verbose_name': 'OurTeam',
                'verbose_name_plural': 'OurTeams',
                'default_related_name': 'market_OurTeam',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_header_origin', models.ImageField(blank=True, null=True, upload_to='market/images/Product/Header/', verbose_name='تصویر سربرگ')),
                ...
                ('rate', models.IntegerField(default=0, verbose_name='امتیاز')),
                ('priority', models.IntegerField(default=1000, verbose_name='ترتیب')),
                ('origin_price', models.IntegerField(blank=True, null=True, verbose_name='قیمت بدون تخفیف')),
                ('short_description', models.CharField(blank=True, max_length=500, null=True, verbose_name='شرح کوتاه')),
                ('description', tinymce.models.HTMLField(blank=True, default='', max_length=5000, null=True, verbose_name='شرح کامل')),
                ...
                ('adder', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='authentication.profile')),
                ...
                ('colors', models.ManyToManyField(blank=True, to='dashboard.Color', verbose_name='رنگ ها')),
                ('comments', models.ManyToManyField(blank=True, to='dashboard.Comment', verbose_name='نظرات کاربرات')),
                ('images', models.ManyToManyField(blank=True, to='dashboard.GalleryPhoto', verbose_name='images')),
                ('metadatas', models.ManyToManyField(blank=True, to='dashboard.MetaData', verbose_name='کلمات کلیدی سئو')),
                ('related', models.ManyToManyField(blank=True, to='market.Product', verbose_name='related')),
                ('tags', models.ManyToManyField(blank=True, to='dashboard.Tag', verbose_name='برچسب ها')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='dashboard.region', verbose_name='region')),
