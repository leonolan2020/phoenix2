...
urlpatterns = [
    ...
    path('archivedocuments/', views.BasicViews().archive_documents,
         name='archivedocuments'),
    path('organizationunits/', views.BasicViews().organizationunits,
         name='organizationunits'),
    path('organization_chart/', views.BasicViews().organizationchart,
    ...
    path('organizationunit/<int:pk>/',
         views.PageViews().organizationunit, name='organizationunit'),
    ...
    path('add_organizationunit/', apis.PageViews().add_organizationunit,
         name='add_organizationunit'),
    ...
    path('edit_project_timing/', apis.PageViews().edit_project_timing,
         name='edit_project_timing'),
    path('tag/<int:pk>/', views.BasicViews().tag, name='tag'),
    path('archivedocument/<int:pk>/',
         views.PageViews().archivedocument, name='archivedocument'),
